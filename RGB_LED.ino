...
#define redpin 9      // red pin of the RGB led is connected to pin 9
#define greenpin 10   // green pin of the RGB led is connected to pin 10
#define bluepin 11    // blue pin of the RGB led is connected to pin 11

void setup() {
  pinMode(redpin, OUTPUT);      //initialize pin 9 as output
  pinMode(greenpin,OUTPUT);     //initialize pin 9 as output
